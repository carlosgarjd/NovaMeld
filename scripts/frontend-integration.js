 ...
 * This file demonstrates how to integrate Novameld with a web frontend
 */

// For React/Vue/Angular applications
export class NovameldClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NovameldClient(provider, contractAddress);
